...
GENRES = [
    "教育・解説", "ビジネス・副業", "エンタメ・バラエティ", "ゲーム・実況",
    "占い・スピリチュアル", "音楽・歌ってみた", "美容・ファッション",
    "グルメ・料理", "Vlog・ライフスタイル", "ママ・育児", "ペット・動物",
    "スポーツ・筋トレ", "車・バイク", "未分類"
]

GENRE_KEYWORDS = {
    "教育・解説": ["解説", "勉強", "知識", "授業", "講義"],
    "ビジネス・副業": ["副業", "稼ぐ", "投資", "起業", "収益"],
    "エンタメ・バラエティ": ["バラエティ", "お笑い", "面白い", "日常", "ネタ"],
    "ゲーム・実況": ["ゲーム", "実況", "プレイ", "やってみた"],
    "占い・スピリチュアル": ["占い", "タロット", "霊視", "スピリチュアル", "運勢"],
    "音楽・歌ってみた": ["歌ってみた", "ピアノ", "作曲", "弾いてみた", "音楽"],
    "美容・ファッション": ["メイク", "美容", "スキンケア", "コスメ", "ファッション"],
    "グルメ・料理": ["料理", "レシピ", "グルメ", "食レポ", "食べてみた"],
    "Vlog・ライフスタイル": ["Vlog", "暮らし", "ルーティン", "ライフスタイル"],
    "ママ・育児": ["育児", "子育て", "ママ", "ベビー"],
    "ペット・動物": ["犬", "猫", "ペット", "動物", "鳴き声"],
    "スポーツ・筋トレ": ["筋トレ", "運動", "健康", "ダイエット", "スポーツ"],
    "車・バイク": ["車", "バイク", "ドライブ", "カスタム"]
}
